...
impl ProfileModelSelector {
    ...
    fn render_model_section(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        // Only show chevron icon if the InlineMenuHeaders feature flag is not enabled
    ...
    fn render_model_spec(
        ...
        let header = self.render_model_spec_header(
            ...
            "CastCodes benchmarks for how well a model performs in our harness, the rate at which it consumes credits, and task speed.".to_string(),
            app,
        );
