...
use crate::{
    ...
    server::{
        ...
        telemetry::{AnonymousUserSignupEntrypoint, CommandXRayTrigger},
    },
...
const CLOUD_MODE_V2_HINT_TEXT: &str = "Kick off an agent";
const CLOUD_HANDOFF_HINT_TEXT: &str = "Start an agent run";
...
impl Input {
    ...
    pub(crate) fn new(
        ...
        // Shared sessions are unavailable in this build; never a viewer.
    ...
    ///
    /// Shared sessions are unavailable in this build, so this is a no-op.
        ...
        match event {
            EditorEvent::Edited(edit_origin) => {
                ...
                let should_run_ai_input_detection = match edit_origin {
                    ...
                    // Remote edits only occur in shared sessions, which are
