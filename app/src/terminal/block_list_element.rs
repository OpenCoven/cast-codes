        ...
        while let Some((visible_idx, block_entry)) = items_iter.next() {
            ...
            match block_entry {
                VisibleItem::Block {
                    ...
                    // Shared-session participants no longer exist in this build, so a
                    // block is "selected by anyone" iff we selected it ourselves.
                ...
                VisibleItem::Banner {
                    ...
                    // Shared-session banners no longer exist in this build, so we always
                    // draw the border above the next block.
                    draw_border_above_block = true;
