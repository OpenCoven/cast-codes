...
const EXPLANATION_TEXT: &str = "Would you like to create an environment for this project? The agent will guide you through choosing GitHub repos, configuring a Docker image, and specifying startup commands.";
