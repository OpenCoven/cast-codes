...
const DRIVE_TITLE: &str = "Cast Drive";
...
const PAYMENT_ISSUE_BANNER_LINE_2_ADMIN_ENTERPRISE: &str =
    "Please open a CastCodes issue to restore access.";
...
impl DriveIndex {
            ...
            (DriveIndexVariant::MainIndex, DriveIndexSection::JoinTeam) => {
                if self.is_online(app) {
                    let join_teams_text = format!(
                        "Collaborate with {} of your teammates already on CastCodes.",
            ...
            |mouse_state| {
                ...
                if mouse_state.is_hovered() {
                    let tooltip = appearance
                        .ui_builder()
                        .tool_tip(String::from("Syncing Cast Drive"));
    ...
    fn render_personal_limit_status(
        ...
        let header = Flex::row()
            ...
            .with_main_axis_alignment(MainAxisAlignment::SpaceBetween)
            .with_child(
                Text::new_inline(DRIVE_TITLE.to_string(), appearance.ui_font_family(), 14.)
