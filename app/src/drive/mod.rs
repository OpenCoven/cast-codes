...
pub struct OpenWarpDriveObjectSettings {
    /// The folder that should be focused in Cast Drive when the object is opened.
...
/// Enum used for sorting elements in the Cast Drive Index (and potentially other places).
...
#[schemars(
    description = "Sort order for Cast Drive items.",
