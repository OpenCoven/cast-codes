...
pub fn render(kind: EmptyKind, font_family: FamilyId, font_size: f32) -> Box<dyn Element> {
    let (title, body) = match kind {
        EmptyKind::NoHistory => (strings::EMPTY_NO_HISTORY_TITLE, strings::EMPTY_NO_HISTORY_BODY),
        EmptyKind::NoPlugin => (strings::EMPTY_NO_PLUGIN_TITLE, strings::EMPTY_NO_PLUGIN_BODY),
