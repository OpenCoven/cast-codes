...
pub(crate) fn build_worktree_config_toml(
    ...
    let quoted_base_branch = shell_words::quote(base_branch);
    ...
    if worktree_branch_name.is_some() {
        ...
        pane.insert(
            ...
            Value::Array(vec![
                Value::String(format!(
                    "git worktree add -b {worktree_branch_name} {worktree_path} {quoted_base_branch}"
                )),
        ...
        pane.insert(
            ...
            Value::Array(vec![
                Value::String(format!(
                    "git worktree add -b {autogenerated_branch_name} {worktree_path} {quoted_base_branch}"
                )),
                Value::String(format!("cd {worktree_path}")),
            ]),
        );
