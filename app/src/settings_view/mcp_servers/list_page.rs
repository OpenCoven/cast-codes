...
impl MCPServersListPageView {
    ...
    fn file_based_root_chip_text(root_path: &PathBuf) -> Option<String> {
        ...
        // If the path is the managed CastCodes data directory, set the text to
        // "global". The CastCodes provider stores its data directory as the root path rather than the
