        ...
        let upgrade_cta_text_fragments =
            if let Some(team) = UserWorkspaces::as_ref(app).current_team() {
                ...
                if team.billing_metadata.can_upgrade_to_higher_tier_plan() {
                    ...
                    vec![
                        FormattedTextFragment::hyperlink("Open an issue", GITHUB_ISSUES_URL),
                        FormattedTextFragment::plain_text(" for more AI usage."),
                    ]
                }
            } else {
            ...
            static AUTODETECTION_DESCRIPTION_FRAGMENTS: LazyLock<Vec<FormattedTextFragment>> =
                LazyLock::new(|| {
                    vec![
                        ...
                        FormattedTextFragment::hyperlink("Let us know", GITHUB_ISSUES_URL),
                    ]
                });
...
struct ApiKeysWidget {
    ...
    github_copilot_api_key_editor: ViewHandle<EditorView>,
...
impl ApiKeysWidget {
    fn new(ctx: &mut ViewContext<<Self as SettingsWidget>::View>) -> Self {
        ...
        let ApiKeys {
            ...
            google: google_key,
            github_copilot: github_copilot_key,
            ..
        ...
        create_api_key_editor!(
            github_copilot_api_key_editor,
            github_copilot_key,
            set_github_copilot_key,
            "ghp_..."
        );
    ...
    fn render_api_keys_section(
        ...
        column.add_child(render_api_key_input(
            ...
            self.github_copilot_api_key_editor.clone(),
            is_enabled,
            app,
        ));
