...
pub enum StartupArgsForwardingError {
    /// There's no instance of CastCodes already running.
...
impl From<zbus::fdo::Error> for StartupArgsForwardingError {
    fn from(value: zbus::fdo::Error) -> Self {
        ...
        // registering a service, so this really means that CastCodes is not already
        // running.
...
// A D-Bus client for connecting to an already-running instance of CastCodes and
// invoking org.freedesktop.Application IPC methods.
#[proxy(
    interface = "org.freedesktop.Application",
    default_service = "dev.castcodes.CastCodes",
    default_path = "/dev/castcodes/CastCodes",
    gen_blocking = false
)]
